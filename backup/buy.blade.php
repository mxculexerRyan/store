                    ...
                    <table id="purchasesTable" class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><select class="js-example-basic-single form-select form-control" id="product_supplier_1" name="product_supplier">
                                ...
                                <td><input type="text" class="form-control" id="price1" name="price"></td>
                                <td><input type="number" class="form-control" id="quantity1" name="qty" disabled onkeyup="getTotal(this)" required ></td>

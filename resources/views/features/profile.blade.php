          ...
          <div class="col-12 grid-margin">
            <div class="card">
              <div class="position-relative">
                <figure class="mb-0 overflow-hidden d-flex justify-content-center">
                  <img src="https://via.placeholder.com/1560x370"class="rounded-top" alt="profile cover">
                </figure>
                <div class="px-2 d-flex justify-content-between align-items-center position-absolute top-90 w-100 px-md-4 mt-n4">
                  <div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row ms-0 me-0">
                      <a href="javascript:;" class="col-md-4 ps-1 pe-1">
                        <figure class="mb-2">
                          <img class="rounded img-fluid" src="https://via.placeholder.com/96x96" alt="">
                        </figure>
                      </a>
                      <a href="javascript:;" class="col-md-4 ps-1 pe-1">
                        <figure class="mb-2">
              ...
              <div class="col-md-12 grid-margin">
                <div class="rounded card">
                  <div class="card-body">
                    ...
                    <div class="pb-2 mb-2 d-flex justify-content-between border-bottom">
                      ...
                      <button class="border-0 btn btn-icon"><i data-feather="user-plus"></i></button>
                    </div>
                    <div class="pb-2 mb-2 d-flex justify-content-between border-bottom">
                      <div class="d-flex align-items-center hover-pointer">
                        <img class="img-xs rounded-circle" src="https://via.placeholder.com/37x37" alt="">											

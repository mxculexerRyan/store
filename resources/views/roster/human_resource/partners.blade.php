            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-3 d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <button type="button" class="items-center d-flex btn btn-primary btn-icon-text" data-bs-toggle="modal" data-bs-target="#addPartnerModal">
                                <i class="btn-icon-prepend" data-feather="tag"></i>Add Partner 
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table id="dataTableExample" class="table">
                            ...
                            <tbody>
                            @foreach ($partnerData as $key => $item)
                            <tr>
                                <td>{{ $key+1 }}</td>
                                @if ($item->photo != "")
                                ...
                                <td>{{ $item->partner_account }}</td>
                                <td>@if ($item->partner_status == "available")
                                    <span class="border badge border-success text-success">{{ $item->partner_status }}</span>
                                @else
                                <span class="border badge border-warning text-warning">{{ $item->partner_status }}</span>
                                @endif</td>
